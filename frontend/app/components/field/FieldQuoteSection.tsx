  ...
  return (
    <section className="bg-white px-6" aria-labelledby="field-quote-heading">
      <div className="mx-auto flex max-w-[960px] flex-col items-center border-b border-[#555] py-20 md:py-[100px]">
        ...
        <Image src={FIELD_QUOTE.decorTopSrc} alt="" width={65} height={65} className="h-auto w-[65px]" />
        ...
        <Image src={FIELD_QUOTE.decorBottomSrc} alt="" width={65} height={65} className="h-auto w-[65px]" />
      </div>
    </section>
  );
}
