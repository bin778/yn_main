  ...
  return (
    <section className="bg-white" aria-labelledby="who-we-are-heading">
      <div className="mx-auto max-w-[1200px] px-6 py-16 md:px-12 md:py-24">
        ...
        <div className="mt-6 md:mt-8 md:grid md:grid-cols-12 md:gap-12">
          <div className="md:col-span-5">
            <p className="text-center text-4xl font-bold leading-tight tracking-tight text-[#121212] md:text-left md:text-[45px]">
