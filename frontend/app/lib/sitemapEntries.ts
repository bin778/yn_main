...
const STATIC_PAGES: readonly SitemapPageConfig[] = [
  ...
  { path: '/criminal/indecent-assault2/', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/criminal/interim-measure/', changeFrequency: 'monthly', priority: 0.9 },
  { path: '/criminal/lawyer/', changeFrequency: 'monthly', priority: 0.9 },
