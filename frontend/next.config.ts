...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/success-story/real-estate', destination: '/success-story/civil/real-estate/', permanent: true },
      { source: '/success-story/real-estate/', destination: '/success-story/civil/real-estate/', permanent: true },
      { source: '/column/real-estate', destination: '/column/civil/real-estate/', permanent: true },
      { source: '/column/real-estate/', destination: '/column/civil/real-estate/', permanent: true },
